...
<template>
	<GlobalHeader />
	<h1 class="font-bold mb-10"><span class="text-zinc-400 font-normal">Tag:</span> {{tag}} </h1>
		<div>
		<div class="border-b">
		...
		<a :href="article._path" class="block text-zinc-500 px-4 py-5 border-b cursor-pointer hover:bg-zinc-100" v-for="article in contentList"
			:key="article._path">
			<div  class="flex">
